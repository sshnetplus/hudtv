  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-transparent text-foreground hover:bg-accent hover:text-accent-foreground transition-smooth",
        ...
        hero: "gradient-hero text-white font-semibold shadow-glow hover:shadow-premium transform hover:scale-105 transition-spring",
        premium: "gradient-premium text-premium-foreground font-semibold shadow-premium hover:shadow-glow transform hover:scale-105 transition-spring",
